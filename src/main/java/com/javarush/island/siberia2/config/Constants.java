...
public class Constants {
    ...
    public static final int THRESHOLD_DIVIDER = 10;
    ...
    public static final int FOREST_COUNT = 5; // default 5
    public static final int FOREST_SIZE = 6; // default 6
    public static final int FIELD_COUNT = 3; // default 3
    public static final int FIELD_SIZE = 4; // default 4
    public static final int RIVER_COUNT = 2; // default 2
    public static final int ROAD_COUNT = 2; // default 2
    public static final int LAKE_COUNT = 1; // default 1
